...
from instapic.models import User, Photo, PhotoTag, PhotoLikes, Followers
...
class AjaxSavePhoto(Ajax):
    def validate(self):
        ...
        tag_count = 0
        p = Photo(url=self.url, baseurl=self.baseurl, owner=self.user.username, likes=0, caption=self.caption,
